...
import 'package:mobile/modules/management/widgets/management/organization_item.widget.dart';
  ...
  Widget build(BuildContext context) {
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        return OrganizationItem(currentOrganization: currentOrganization);
      },
